...
def options_and_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Programming-Machine thinks for you about the meanings.",
        epilog="Example:  programming-machine input_text.txt > output_text.txt"
...
def run():
    """
    $ text | programming-machine                        # Accepts text from the pipe
    $ echo "...<text>..." | programming-machine         #

    $ programming-machine multilogue.txt new_turn.txt    # ...or files.
    """
